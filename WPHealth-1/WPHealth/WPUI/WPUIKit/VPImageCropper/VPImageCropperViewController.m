...
- (void)initControlBtn {
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 60.0f, self.view.frame.size.width/2-1, 60.0f)];
    cancelBtn.backgroundColor = RGBA(100, 100, 100, 0.5);
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width/2, self.view.frame.size.height - 60.0f, self.view.frame.size.width/2, 60.0f)];
    confirmBtn.backgroundColor = RGBA(100, 100, 100, .5);
...
//    UIImage* smallImage = [UIImage imageWithCGImage:subImageRef];
    UIImage *smallImage = [UIImage imageWithCGImage:subImageRef scale:1.0F orientation:self.originalImage.imageOrientation];
