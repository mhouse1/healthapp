...
#define MKInfoPanelTag 199998

#define PANELHEIGHT 120.0f
// Private Methods
...
-(void)setType:(MKInfoPanelType)type {
    if(type == MKInfoPanelTypeError) {
        ...
        self.backgroundGradient.backgroundColor = [UIColor colorWithRed:0.0/255.0 green:0.0/255.0 blue:0.0/255.0 alpha:0.8];
        self.titleLabel.textColor = [UIColor colorWithRed:210.0/255.0 green:210.0/255.0 blue:235.0/255.0 alpha:1.0];
        self.titleLabel.font = [UIFont boldSystemFontOfSize:13];
        self.thumbImage.image = [UIImage imageNamed:@"Tick"];   
        self.detailLabel.textColor = [UIColor colorWithRed:210.0/255.0 green:210.0/255.0 blue:235.0/255.0 alpha:1.0];
    }
}
...
//    MKInfoPanel *isExistPanel = (MKInfoPanel *)[view viewWithTag:MKInfoPanelTag];
//    if (isExistPanel) {
//        return nil;
//    }
    ...
    panel.titleLabel.shadowColor = [UIColor clearColor];
    panel.titleLabel.shadowOffset = CGSizeMake(0,1);
    panel.titleLabel.numberOfLines = 5;
 
    NSDictionary *attribute = @{NSFontAttributeName:[UIFont systemFontOfSize:13]};
    CGSize size = [title boundingRectWithSize:CGSizeMake(view.frame.size.width, PANELHEIGHT)
                                      options:(NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading)
                                        attributes:attribute
                                      context:nil].size;
    
//    CGSize size = [title sizeWithFont:[UIFont systemFontOfSize:13]
//                    constrainedToSize:CGSizeMake(view.frame.size.width,
//                                                 PANELHEIGHT)
//                        lineBreakMode:NSLineBreakByWordWrapping];
    
    CGFloat panelHeight = size.height+10.0;   // panel height when no subtitle set
    ...
    if(subtitle) {
        ...
        panelHeight += 8.0f;    // padding at bottom
    } else {
        panel.detailLabel.hidden = YES;
        panel.thumbImage.frame = CGRectMake(15, 5, 35, 15);
        panel.titleLabel.frame = CGRectMake(0, 0, view.frame.size.width, panelHeight);
        
    }
    
    panel.tag = MKInfoPanelTag;
